...
def setup(app):
    app.add_css_file("css/hanlabtheme.css")
...
html_logo = "_static/images/hanlogo.png"


# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "hldoc"
...
latex_documents = [
    (master_doc, "hanlab.tex", u"hanlab Documentation", u"Thomas Casey", "Manual"),
]
...
man_pages = [(master_doc, "hanlab", u"hanlab Documentation", [author], 1)]
